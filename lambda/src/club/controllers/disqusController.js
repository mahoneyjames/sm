// const logger = require("log2")("disqusController");
...
//         else
//         {
//             logger.info("Running a partial sync")
...
//     {
//         const themeSyncLogRecord = logger.track("syncCommentsForTheseThemes");
//         //console.log(themes);
//         const users = await module.data.cache_getUsers();
//         const commentDoc = {comments:[], unknownUsers:[]};
//         for (const theme of themes)
//         {        
//             themeSyncLogRecord.logThing({what:"theme", 
...
//             {
//                 themeSyncLogRecord.logThing({what:"story",
//                                             themePublicId: theme.publicId,
...
//             }
//         }
//         themeSyncLogRecord.appendMessage("Found %s comment(s)", commentDoc.comments.length);
...
//         logger.info("generate comment doc");
